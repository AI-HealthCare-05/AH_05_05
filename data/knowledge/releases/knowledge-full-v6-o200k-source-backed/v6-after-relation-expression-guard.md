...
| 출처 정확도 | 0.692 |
| 근거 커버리지 | 1.000 |
| P50 / P95 | 337.3 / 1305.7 ms |

## 질문별 결과

| 질문 ID | 단계 | 변경 전 | 표현 유형 | 범위 | 처리 상태 | 후보 관련 순위 | Top-5 | 시간(ms) | 판정 |
|---|---|---|---|---|---|---:|---|---:|---|
| exact-product-magnesium | ACTIVE_PHASE | PASS | EXACT_PRODUCT | IN_SCOPE | UNCHANGED | - | - | 1305.7 | PASS |
| typo-brand-tylenol | ACTIVE_PHASE | PASS | PRODUCT_TYPO | IN_SCOPE | AUTO_CORRECTED | - | - | 309.6 | PASS |
| typo-ingredient-acetaminophen | ACTIVE_PHASE | PASS | INGREDIENT_TYPO | IN_SCOPE | AUTO_CORRECTED | 1 | PASS | 371.5 | PASS |
| keyboard-tail-tylenol | ACTIVE_PHASE | PASS | KEYBOARD_TYPO | IN_SCOPE | AUTO_CORRECTED | - | - | 302.8 | PASS |
| spacing-magnesium | ACTIVE_PHASE | PASS | SPACING_VARIATION | IN_SCOPE | AUTO_CORRECTED | 2 | PASS | 263.3 | PASS |
| common-name-tylenol | ACTIVE_PHASE | PASS | COMMON_NAME | IN_SCOPE | UNCHANGED | - | - | 307.2 | PASS |
...
| supplement-guide-magnesium | ACTIVE_PHASE | PASS | COMMON_NAME | IN_SCOPE | UNCHANGED | 2 | PASS | 336.7 | PASS |
| drug-drug-warfarin-metronidazole | ACTIVE_PHASE | PARTIAL | DRUG_DRUG | IN_SCOPE | UNCHANGED | 1 | PASS | 337.9 | PASS |
| drug-supplement-warfarin-vitamin-k | ACTIVE_PHASE | PARTIAL | DRUG_SUPPLEMENT | IN_SCOPE | UNCHANGED | 1 | PASS | 343.4 | PASS |
| supplement-supplement-calcium-iron | ACTIVE_PHASE | PARTIAL | SUPPLEMENT_SUPPLEMENT | IN_SCOPE | UNCHANGED | - | FAIL | 404.9 | EXPECTED_DOCUMENT_NOT_IN_TOP_20, EXPECTED_DOCUMENT_NOT_IN_TOP_5 |
| drug-food-fexofenadine-fruit-juice | ACTIVE_PHASE | PARTIAL | DRUG_FOOD | IN_SCOPE | UNCHANGED | 1 | PASS | 292.1 | PASS |
| drug-food-tylenol-alcohol | ACTIVE_PHASE | FAIL | DRUG_FOOD | IN_SCOPE | UNCHANGED | - | - | 343.9 | PASS |
| alphabet-pronunciation-vitamin-d | ACTIVE_PHASE | FAIL | COMMON_NAME | IN_SCOPE | AUTO_CORRECTED | - | - | 351.1 | PASS |
| colloquial-relation-warfarin-vitamin-k | ACTIVE_PHASE | FAIL | DRUG_SUPPLEMENT | IN_SCOPE | AUTO_CORRECTED | 1 | PASS | 337.3 | PASS |
...
| deferred-safety-calcium-iron | DEFERRED_SAFETY | FAIL | SUPPLEMENT_SUPPLEMENT | IN_SCOPE | UNCHANGED | - | - | 305.8 | TYPED_ENTITY_MISMATCH |
