...
| 출처 정확도 | 0.692 |
| 근거 커버리지 | 1.000 |
| P50 / P95 | 290.6 / 571.2 ms |

## 질문별 결과

| 질문 ID | 단계 | 변경 전 | 표현 유형 | 범위 | 처리 상태 | 후보 관련 순위 | Top-5 | 시간(ms) | 판정 |
|---|---|---|---|---|---|---:|---|---:|---|
| exact-product-magnesium | ACTIVE_PHASE | PASS | EXACT_PRODUCT | IN_SCOPE | UNCHANGED | - | - | 491.5 | PASS |
| typo-brand-tylenol | ACTIVE_PHASE | PASS | PRODUCT_TYPO | IN_SCOPE | AUTO_CORRECTED | - | - | 287.7 | PASS |
| typo-ingredient-acetaminophen | ACTIVE_PHASE | PASS | INGREDIENT_TYPO | IN_SCOPE | AUTO_CORRECTED | 1 | PASS | 336.6 | PASS |
| keyboard-tail-tylenol | ACTIVE_PHASE | PASS | KEYBOARD_TYPO | IN_SCOPE | AUTO_CORRECTED | - | - | 335.6 | PASS |
| spacing-magnesium | ACTIVE_PHASE | PASS | SPACING_VARIATION | IN_SCOPE | AUTO_CORRECTED | 2 | PASS | 265.1 | PASS |
| common-name-tylenol | ACTIVE_PHASE | PASS | COMMON_NAME | IN_SCOPE | UNCHANGED | - | - | 280.3 | PASS |
...
| supplement-guide-magnesium | ACTIVE_PHASE | PASS | COMMON_NAME | IN_SCOPE | UNCHANGED | 2 | PASS | 352.4 | PASS |
| drug-drug-warfarin-metronidazole | ACTIVE_PHASE | PARTIAL | DRUG_DRUG | IN_SCOPE | UNCHANGED | 1 | PASS | 283.8 | PASS |
| drug-supplement-warfarin-vitamin-k | ACTIVE_PHASE | PARTIAL | DRUG_SUPPLEMENT | IN_SCOPE | UNCHANGED | 1 | PASS | 289.9 | PASS |
| supplement-supplement-calcium-iron | ACTIVE_PHASE | PARTIAL | SUPPLEMENT_SUPPLEMENT | IN_SCOPE | UNCHANGED | - | FAIL | 290.6 | EXPECTED_DOCUMENT_NOT_IN_TOP_20, EXPECTED_DOCUMENT_NOT_IN_TOP_5 |
| drug-food-fexofenadine-fruit-juice | ACTIVE_PHASE | PARTIAL | DRUG_FOOD | IN_SCOPE | UNCHANGED | 1 | PASS | 276.1 | PASS |
| drug-food-tylenol-alcohol | ACTIVE_PHASE | FAIL | DRUG_FOOD | IN_SCOPE | UNCHANGED | - | - | 331.5 | PASS |
| alphabet-pronunciation-vitamin-d | ACTIVE_PHASE | FAIL | COMMON_NAME | IN_SCOPE | AUTO_CORRECTED | - | - | 246.9 | PASS |
| colloquial-relation-warfarin-vitamin-k | ACTIVE_PHASE | FAIL | DRUG_SUPPLEMENT | IN_SCOPE | AUTO_CORRECTED | 1 | PASS | 571.2 | PASS |
...
| deferred-safety-calcium-iron | DEFERRED_SAFETY | FAIL | SUPPLEMENT_SUPPLEMENT | IN_SCOPE | UNCHANGED | - | - | 300.6 | TYPED_ENTITY_MISMATCH |
