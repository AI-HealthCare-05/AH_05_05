...
| 출처 정확도 | 0.778 |
| 근거 커버리지 | 0.750 |
| P50 / P95 | 241.7 / 799.5 ms |

## 질문별 결과

| 질문 ID | 단계 | 변경 전 | 표현 유형 | 범위 | 처리 상태 | 후보 관련 순위 | Top-5 | 시간(ms) | 판정 |
|---|---|---|---|---|---|---:|---|---:|---|
| exact-product-magnesium | ACTIVE_PHASE | PASS | EXACT_PRODUCT | IN_SCOPE | UNCHANGED | - | - | 799.5 | PASS |
| typo-brand-tylenol | ACTIVE_PHASE | PASS | PRODUCT_TYPO | IN_SCOPE | AUTO_CORRECTED | - | - | 228.4 | PASS |
| typo-ingredient-acetaminophen | ACTIVE_PHASE | PASS | INGREDIENT_TYPO | IN_SCOPE | AUTO_CORRECTED | 1 | PASS | 250.2 | PASS |
| keyboard-tail-tylenol | ACTIVE_PHASE | PASS | KEYBOARD_TYPO | IN_SCOPE | AUTO_CORRECTED | - | - | 233.9 | PASS |
| spacing-magnesium | ACTIVE_PHASE | PASS | SPACING_VARIATION | IN_SCOPE | AUTO_CORRECTED | 1 | PASS | 185.3 | PASS |
| common-name-tylenol | ACTIVE_PHASE | PASS | COMMON_NAME | IN_SCOPE | UNCHANGED | - | - | 245.8 | PASS |
| ambiguous-near-product | ACTIVE_PHASE | PASS | AMBIGUOUS | IN_SCOPE | CLARIFICATION_REQUIRED | - | - | 0.0 | PASS |
| short-unsafe-correction | ACTIVE_PHASE | PASS | SHORT_EXPRESSION | IN_SCOPE | UNRESOLVED | - | - | 168.9 | UNEXPECTED_RAG_EXECUTED |
| out-of-scope-hungry | ACTIVE_PHASE | PASS | OUT_OF_SCOPE | OUT_OF_SCOPE | UNRESOLVED | - | - | 0.0 | PASS |
| in-scope-no-evidence | ACTIVE_PHASE | PASS | IN_SCOPE_NO_EVIDENCE | IN_SCOPE | UNRESOLVED | - | - | 285.9 | UNEXPECTED_RAG_EXECUTED |
| supplement-guide-magnesium | ACTIVE_PHASE | PASS | COMMON_NAME | IN_SCOPE | UNCHANGED | 1 | PASS | 201.1 | PASS |
| drug-drug-warfarin-metronidazole | ACTIVE_PHASE | PARTIAL | DRUG_DRUG | IN_SCOPE | UNCHANGED | 1 | PASS | 238.8 | PASS |
| drug-supplement-warfarin-vitamin-k | ACTIVE_PHASE | PARTIAL | DRUG_SUPPLEMENT | IN_SCOPE | UNCHANGED | 1 | PASS | 386.6 | PASS |
| supplement-supplement-calcium-iron | ACTIVE_PHASE | PARTIAL | SUPPLEMENT_SUPPLEMENT | IN_SCOPE | UNCHANGED | - | FAIL | 241.7 | EXPECTED_DOCUMENT_NOT_IN_TOP_20, EXPECTED_DOCUMENT_NOT_IN_TOP_5 |
| drug-food-fexofenadine-fruit-juice | ACTIVE_PHASE | PARTIAL | DRUG_FOOD | IN_SCOPE | UNCHANGED | - | FAIL | 394.5 | ENTITY_MISMATCH, TYPED_ENTITY_MISMATCH, INTERACTION_PAIR_MISMATCH, EXPECTED_DOCUMENT_NOT_IN_TOP_20, EXPECTED_DOCUMENT_NOT_IN_TOP_5 |
| drug-food-tylenol-alcohol | ACTIVE_PHASE | FAIL | DRUG_FOOD | IN_SCOPE | UNCHANGED | - | - | 245.5 | PASS |
| alphabet-pronunciation-vitamin-d | ACTIVE_PHASE | FAIL | COMMON_NAME | IN_SCOPE | AUTO_CORRECTED | - | - | 188.4 | PASS |
| colloquial-relation-warfarin-vitamin-k | ACTIVE_PHASE | FAIL | DRUG_SUPPLEMENT | IN_SCOPE | UNCHANGED | 6 | FAIL | 273.6 | RESOLUTION_STATUS_MISMATCH, RESOLVED_QUESTION_MISMATCH, INTERACTION_PAIR_MISMATCH, SECTION_MISMATCH, EXPECTED_DOCUMENT_NOT_IN_TOP_5 |
| deferred-memory-pronoun | DEFERRED_MEMORY | FAIL | COMMON_NAME | IN_SCOPE | UNRESOLVED | - | - | 200.0 | UNEXPECTED_RAG_EXECUTED |
| deferred-context-registered-medication | DEFERRED_CONTEXT | FAIL | COMMON_NAME | IN_SCOPE | UNRESOLVED | - | - | 176.7 | UNEXPECTED_RAG_EXECUTED |
| deferred-safety-calcium-iron | DEFERRED_SAFETY | FAIL | SUPPLEMENT_SUPPLEMENT | IN_SCOPE | UNCHANGED | - | - | 254.0 | TYPED_ENTITY_MISMATCH |
