...
- 미커밋 변경 포함: 예
- Collection: `medication_knowledge_full_v6`
...
- 검색 모드: `DENSE`
- Dataset: `knowledge-full-v6-o200k-source-backed`
...
| 출처 정확도 | 0.667 |
| 근거 커버리지 | 0.875 |
| P50 / P95 | 267.2 / 456.3 ms |

## 질문별 결과

| 질문 ID | 단계 | 변경 전 | 표현 유형 | 범위 | 처리 상태 | 후보 관련 순위 | Top-5 | 시간(ms) | 판정 |
|---|---|---|---|---|---|---:|---|---:|---|
| exact-product-magnesium | ACTIVE_PHASE | PASS | EXACT_PRODUCT | IN_SCOPE | UNCHANGED | - | - | 456.3 | PASS |
| typo-brand-tylenol | ACTIVE_PHASE | PASS | PRODUCT_TYPO | IN_SCOPE | AUTO_CORRECTED | - | - | 260.3 | PASS |
| typo-ingredient-acetaminophen | ACTIVE_PHASE | PASS | INGREDIENT_TYPO | IN_SCOPE | AUTO_CORRECTED | 1 | PASS | 297.6 | PASS |
| keyboard-tail-tylenol | ACTIVE_PHASE | PASS | KEYBOARD_TYPO | IN_SCOPE | AUTO_CORRECTED | - | - | 286.2 | PASS |
| spacing-magnesium | ACTIVE_PHASE | PASS | SPACING_VARIATION | IN_SCOPE | AUTO_CORRECTED | 2 | PASS | 258.9 | PASS |
| common-name-tylenol | ACTIVE_PHASE | PASS | COMMON_NAME | IN_SCOPE | UNCHANGED | - | - | 280.2 | PASS |
| ambiguous-near-product | ACTIVE_PHASE | PASS | AMBIGUOUS | IN_SCOPE | CLARIFICATION_REQUIRED | - | - | 0.0 | PASS |
| short-unsafe-correction | ACTIVE_PHASE | PASS | SHORT_EXPRESSION | IN_SCOPE | UNRESOLVED | - | - | 183.2 | UNEXPECTED_RAG_EXECUTED |
| out-of-scope-hungry | ACTIVE_PHASE | PASS | OUT_OF_SCOPE | OUT_OF_SCOPE | UNRESOLVED | - | - | 0.0 | PASS |
| in-scope-no-evidence | ACTIVE_PHASE | PASS | IN_SCOPE_NO_EVIDENCE | IN_SCOPE | UNRESOLVED | - | - | 150.3 | UNEXPECTED_RAG_EXECUTED |
| supplement-guide-magnesium | ACTIVE_PHASE | PASS | COMMON_NAME | IN_SCOPE | UNCHANGED | 2 | PASS | 254.7 | PASS |
| drug-drug-warfarin-metronidazole | ACTIVE_PHASE | PARTIAL | DRUG_DRUG | IN_SCOPE | UNCHANGED | 1 | PASS | 275.5 | PASS |
| drug-supplement-warfarin-vitamin-k | ACTIVE_PHASE | PARTIAL | DRUG_SUPPLEMENT | IN_SCOPE | UNCHANGED | 1 | PASS | 263.9 | PASS |
| supplement-supplement-calcium-iron | ACTIVE_PHASE | PARTIAL | SUPPLEMENT_SUPPLEMENT | IN_SCOPE | UNCHANGED | - | FAIL | 322.4 | EXPECTED_DOCUMENT_NOT_IN_TOP_20, EXPECTED_DOCUMENT_NOT_IN_TOP_5 |
| drug-food-fexofenadine-fruit-juice | ACTIVE_PHASE | PARTIAL | DRUG_FOOD | IN_SCOPE | UNCHANGED | 1 | PASS | 267.2 | PASS |
| drug-food-tylenol-alcohol | ACTIVE_PHASE | FAIL | DRUG_FOOD | IN_SCOPE | UNCHANGED | - | - | 279.1 | PASS |
| alphabet-pronunciation-vitamin-d | ACTIVE_PHASE | FAIL | COMMON_NAME | IN_SCOPE | AUTO_CORRECTED | - | - | 243.3 | PASS |
| colloquial-relation-warfarin-vitamin-k | ACTIVE_PHASE | FAIL | DRUG_SUPPLEMENT | IN_SCOPE | UNCHANGED | 8 | FAIL | 319.5 | RESOLUTION_STATUS_MISMATCH, RESOLVED_QUESTION_MISMATCH, INTERACTION_PAIR_MISMATCH, SECTION_MISMATCH, EXPECTED_DOCUMENT_NOT_IN_TOP_5 |
| deferred-memory-pronoun | DEFERRED_MEMORY | FAIL | COMMON_NAME | IN_SCOPE | UNRESOLVED | - | - | 163.1 | UNEXPECTED_RAG_EXECUTED |
| deferred-context-registered-medication | DEFERRED_CONTEXT | FAIL | COMMON_NAME | IN_SCOPE | UNRESOLVED | - | - | 167.4 | UNEXPECTED_RAG_EXECUTED |
| deferred-safety-calcium-iron | DEFERRED_SAFETY | FAIL | SUPPLEMENT_SUPPLEMENT | IN_SCOPE | UNCHANGED | - | - | 282.7 | TYPED_ENTITY_MISMATCH |
