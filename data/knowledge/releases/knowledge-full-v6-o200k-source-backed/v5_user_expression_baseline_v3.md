...
- Git commit: `07865f069dc36298adfb222f11440ecb103fe2ad`
- 미커밋 변경 포함: 예
...
- 유사도 기준: 0.65
- 후보/최종: Top-20 / Top-5
- 평가 YAML SHA-256: `8553bfe978318e931e16d659fd25b812f145b805fbd07db749153db424cfc0ad`

## 실험 근거

- 목적: source-backed typed entity와 FOOD 메타데이터 도입 전후를 같은 21문항으로 비교하여, 정확한 대상·pair·근거가 유지되는지 검증한다.
- 채택 기준: ACTIVE_PHASE의 모든 문항이 통과하고 잘못된 대상 혼입이 0건이며, 기존 PASS 11건보다 전체 PASS가 감소하지 않을 때만 새 불변 Qdrant 릴리스를 활성화 후보로 검토한다.
...
| 출처 정확도 | 0.778 |
| 근거 커버리지 | 0.750 |
| P50 / P95 | 236.0 / 1661.0 ms |

## 질문별 결과

| 질문 ID | 단계 | 변경 전 | 표현 유형 | 범위 | 처리 상태 | 후보 관련 순위 | Top-5 | 시간(ms) | 판정 |
|---|---|---|---|---|---|---:|---|---:|---|
| exact-product-magnesium | ACTIVE_PHASE | PASS | EXACT_PRODUCT | IN_SCOPE | UNCHANGED | - | - | 755.7 | ENTITY_MISMATCH, TYPED_ENTITY_MISMATCH |
| typo-brand-tylenol | ACTIVE_PHASE | PASS | PRODUCT_TYPO | IN_SCOPE | AUTO_CORRECTED | - | - | 306.8 | ENTITY_MISMATCH, TYPED_ENTITY_MISMATCH |
| typo-ingredient-acetaminophen | ACTIVE_PHASE | PASS | INGREDIENT_TYPO | IN_SCOPE | AUTO_CORRECTED | 1 | PASS | 233.4 | PASS |
| keyboard-tail-tylenol | ACTIVE_PHASE | PASS | KEYBOARD_TYPO | IN_SCOPE | AUTO_CORRECTED | - | - | 236.0 | ENTITY_MISMATCH, TYPED_ENTITY_MISMATCH |
| spacing-magnesium | ACTIVE_PHASE | PASS | SPACING_VARIATION | IN_SCOPE | AUTO_CORRECTED | 1 | PASS | 188.5 | PASS |
| common-name-tylenol | ACTIVE_PHASE | PASS | COMMON_NAME | IN_SCOPE | UNCHANGED | - | - | 236.4 | ENTITY_MISMATCH, TYPED_ENTITY_MISMATCH |
| ambiguous-near-product | ACTIVE_PHASE | PASS | AMBIGUOUS | IN_SCOPE | CLARIFICATION_REQUIRED | - | - | 0.0 | PASS |
| short-unsafe-correction | ACTIVE_PHASE | PASS | SHORT_EXPRESSION | IN_SCOPE | UNRESOLVED | - | - | 184.4 | UNEXPECTED_RAG_EXECUTED |
| out-of-scope-hungry | ACTIVE_PHASE | PASS | OUT_OF_SCOPE | OUT_OF_SCOPE | UNRESOLVED | - | - | 0.0 | PASS |
| in-scope-no-evidence | ACTIVE_PHASE | PASS | IN_SCOPE_NO_EVIDENCE | IN_SCOPE | UNRESOLVED | - | - | 196.2 | UNEXPECTED_RAG_EXECUTED |
| supplement-guide-magnesium | ACTIVE_PHASE | PASS | COMMON_NAME | IN_SCOPE | UNCHANGED | 1 | PASS | 200.6 | PASS |
| drug-drug-warfarin-metronidazole | ACTIVE_PHASE | PARTIAL | DRUG_DRUG | IN_SCOPE | UNCHANGED | 1 | PASS | 238.2 | PASS |
| drug-supplement-warfarin-vitamin-k | ACTIVE_PHASE | PARTIAL | DRUG_SUPPLEMENT | IN_SCOPE | UNCHANGED | 1 | PASS | 373.4 | PASS |
| supplement-supplement-calcium-iron | ACTIVE_PHASE | PARTIAL | SUPPLEMENT_SUPPLEMENT | IN_SCOPE | UNCHANGED | - | FAIL | 267.1 | EXPECTED_DOCUMENT_NOT_IN_TOP_20, EXPECTED_DOCUMENT_NOT_IN_TOP_5 |
...
| drug-food-tylenol-alcohol | ACTIVE_PHASE | FAIL | DRUG_FOOD | IN_SCOPE | UNCHANGED | - | - | 227.9 | ENTITY_MISMATCH, TYPED_ENTITY_MISMATCH, INTERACTION_PAIR_MISMATCH |
| alphabet-pronunciation-vitamin-d | ACTIVE_PHASE | FAIL | COMMON_NAME | IN_SCOPE | AUTO_CORRECTED | - | - | 183.5 | PASS |
| colloquial-relation-warfarin-vitamin-k | ACTIVE_PHASE | FAIL | DRUG_SUPPLEMENT | IN_SCOPE | UNCHANGED | 6 | FAIL | 244.8 | RESOLUTION_STATUS_MISMATCH, RESOLVED_QUESTION_MISMATCH, INTERACTION_PAIR_MISMATCH, SECTION_MISMATCH, EXPECTED_DOCUMENT_NOT_IN_TOP_5 |
| deferred-memory-pronoun | DEFERRED_MEMORY | FAIL | COMMON_NAME | IN_SCOPE | UNRESOLVED | - | - | 176.9 | UNEXPECTED_RAG_EXECUTED |
| deferred-context-registered-medication | DEFERRED_CONTEXT | FAIL | COMMON_NAME | IN_SCOPE | UNRESOLVED | - | - | 212.5 | UNEXPECTED_RAG_EXECUTED |
| deferred-safety-calcium-iron | DEFERRED_SAFETY | FAIL | SUPPLEMENT_SUPPLEMENT | IN_SCOPE | UNCHANGED | - | - | 1661.0 | TYPED_ENTITY_MISMATCH |
...
- 평가 이유: 음식 별칭이 실제 카탈로그에 있을 때만 약-음식 pair를 생성하는지 확인한다.
- 근거 유형: `NO_EVIDENCE`
- 정답 Qdrant 문서: 해당 없음
