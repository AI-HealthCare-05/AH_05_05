...
class StJohnsWortReviewLayoutParser:
    """검수된 St John's wort 체계적 문헌고찰의 본문만 읽습니다."""

    _SOURCE_ID = "research_herb_drug_interactions"
    _DOCUMENT_ID = "research_herb_drug_interactions-e5fcbe5d02f9650c"
    ...
    def _regions(page_number: int) -> tuple[_Region, ...]:
        if page_number == 1:
            return (
                _Region(55.0, 175.0, 475.0, 220.0),
                _Region(55.0, 250.0, 260.0, 640.0),
                _Region(55.0, 645.0, 260.0, 775.0),
                _Region(265.0, 250.0, 475.0, 310.0),
                _Region(265.0, 310.0, 475.0, 735.0),
            )
        if page_number == 2:
            return (
                _Region(125.0, 70.0, 335.0, 190.0),
                _Region(125.0, 190.0, 335.0, 500.0),
                _Region(338.0, 70.0, 545.0, 190.0),
                _Region(338.0, 190.0, 545.0, 325.0),
                _Region(338.0, 325.0, 545.0, 500.0),
            )
        return (
            _Region(55.0, 70.0, 260.0, 505.0),
            _Region(265.0, 255.0, 475.0, 470.0),
            _Region(265.0, 75.0, 475.0, 255.0),
        )
