...
class MedicationAnswerFallbackReason(StrEnum):
    ...
    OFFICIAL_WARNING_PRESERVED = "OFFICIAL_WARNING_PRESERVED"
    PATIENT_CONTEXT_ONLY = "PATIENT_CONTEXT_ONLY"
    CLARIFICATION_REQUIRED = "CLARIFICATION_REQUIRED"
    EVIDENCE_GAP_NOTICE = "EVIDENCE_GAP_NOTICE"
...
class MedicationChatResult(BaseModel):
    ...
    evidence_reasoning: EvidenceReasoningOutput | None = Field(
        default=None,
        exclude=True,
    )
