  ...
  return (
    ...
    >
      ...
      <LegalSection title="3. 처리하는 개인정보 항목">
        ...
        <p className="mt-2">
          약봉투 이미지는 OCR 처리와 결과 검토를 위해 메모리에만 임시로 보관하며, 결과 검토가 가능해진
          시점부터 최대 60분 후 또는 이용자가 결과를 확정하거나 취소하면 삭제합니다. 처리 중에도 임시
          보관 기한을 적용하며, 이미지 파일은 영구 저장하지 않습니다. 추출 결과와
          이용자가 수정·확정한 값의 보유·이용 기간은 이미지 보관과 별도로 적용됩니다.
        </p>
      </LegalSection>
