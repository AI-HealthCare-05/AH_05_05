...
def test_exact_minimal_model_fields() -> None:
...
def test_enums_unique_constraints_and_delete_policies_match_storage_contract() -> None:
...
async def test_rejects_duplicate_target_source_for_participation() -> None:
...
async def test_rejects_duplicate_occurrence_slot_for_target() -> None:
...
async def test_source_deletion_nullifies_fk_without_deleting_history() -> None:
    _, _, target_model, occurrence_model = _custom_models()
...
async def test_participation_deletion_cascades_to_targets_and_occurrences() -> None:
    _, _, target_model, occurrence_model = _custom_models()
...
async def test_target_deletion_cascades_to_occurrences() -> None:
    _, _, _, occurrence_model = _custom_models()
    *_, target, occurrence = await _create_target_and_occurrence()
...
async def test_template_deletion_is_restricted_while_participation_exists() -> None:
